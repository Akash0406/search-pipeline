...
shadcn/ui is intentionally _not_ an installed dependency — its model is to copy
...
indicator, status badge, etc.) are original CareerStack code built _on top of_
