 ...
 * (Req 49), partial data deletion (Req 50.2), and the raw-source retention
 * policy surface (Req 53.1).
 *
 * Connection routes (list/create/pause/remove/run/manual-url/disconnect) now
 * live in the dedicated {@link ConnectionsModule} (Design API §7 Sources/Runs);
 * this module no longer owns them.
 *
